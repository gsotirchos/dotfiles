...
;; Package-Version: 20260826.245
;; Package-Revision: 67706445e4c4
...
;; Vendored from https://github.com/thisisran/flymake-bashate (GPL-3.0+),
;; unchanged.  It is carried here only so that it is expanded against the
;; patched `flymake-quickdef' in this directory: the backend is generated by
;; a macro, so the ELPA build has the old, local-only `make-process' call
;; baked into its .elc and cannot pick the fix up at load time.
